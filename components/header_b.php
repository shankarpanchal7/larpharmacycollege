  ...
  <header style="position: relative;">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="logo-top-left">  
                <a href="/"><img class="logo-top" alt="logo" src="/img/logo_tr.png"></a>
            </div>
        </div>
        <div class="col-md-8">
    ...
    <!--       
        ...
        right: 35px;">
            ...
            <div class="approvals"><img src="img/approvel/AICTE.png" alt="AICTE"></div>
            <div class="approvals"><img src="/img/approvel/my1.png" alt="AICTE"></div>
            <div class="approvals"><img src="/img/approvel/my2.png" alt="AICTE"></div>
            <div class="approvals"><img src="/img/approvel/my3.png" alt="AICTE"></div>
            <div class="approvals"><img src="/img/approvel/my4.png" alt="AICTE"></div>
            </div> -->
            ...
            flex-wrap: wrap;">
                ...
                <div class="approvals"><img src="img/approvel/my3.png" alt="AICTE"></div>
                <div class="approvals"><img src="img/approvel/my4.png" alt="AICTE"></div>
                <div class="approvals"><img src="img/approvel/DTE.png" alt="AICTE"></div>
            </div> -->
        <!-- </div> -->
        <div class="col-md-2 d-flex" style="align-self: center;flex-wrap: wrap; justify-content: center;">
                <img style="border-radius: 10px;object-fit: cover;height: 135px;margin-top: 7px;" src="/img/trust.jpeg" alt="">
        </div>
    </div>
        </div>
    </div>
    ...
    <ul class="navbar-header topnav">
        ...
        <!-- <li class="topnav-list">
            <a class="dropdown-toggle" id="navbarDropdown0" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Facilities</a>
            <ul class="my-sub-menu dropdown-menu mega-dropdown-menu mega_dropdown" id="navbarDropdowndropme">
                <div class="row">
                    <div class="col-md-3">
                        <ul class="my-sub-menu-nav">
                        <li><a href="class-room.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Class room</a></li>
                        <li><a href="/computer-lab.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Computer & Language Laboratory</a></li>
                        <li><a href="/laboratories.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Laboratories</a></li>
                        <li><a href="/centeral-instruments.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Central Instrumentation </a></li>
                        <li><a href="/library.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Library</a></li>
                        <li><a href="/animal-house.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Animal house</a></li>
                    ...
                    <div class="col-md-6">
                        <ul class="my-sub-menu-nav">
                            <li><a href="/museum.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Museum</a></li>
                            <li><a href="/herbal-garden.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Herbal garden</a></li>
                            <li><a href="/otherfacility.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Other facilities</a></li>
                            <li><a href="/cctvfacility.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;CCTV Camera</a></li>
                            <li><a href="/Rainwaterharvesting.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Rain Water harvesting</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Disability resource facility</a></li>
                            <li><a href="/electric-back-up.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;24 Hrs. electric backup</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3">
                        <ul class="my-sub-menu-nav">
                        <li><a href="/transportation.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Transportation</a></li>
                        <li><a href="/canteen.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Canteen</a></li>
                        <li><a href="/medical-facility.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Medical facility</a></li>
                        <li><a href="/corporate-store.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Corporate store</a></li>
                        <li><a href="/Janaaushadhi-store.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Janaaushadhi store</a></li>
                        <li><a href="/auditorium.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Auditorium</a></li>
                        </ul>
                    </div>
                </div>                    
            </ul>
...
<li><a href="/students-grievance-redressal-cell.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp; Students Grievance Redressal Cell</a></li>
        ...
        <!--<li class="topnav-list md-dropdown">-->
        <!--    <a class="dropdown-toggle" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Event</a>-->

        <!--    <ul class="my-sub-menu dropdown-menu md-dropdown-menu" id="navbarDropdowndropme">-->
        <!--    <li><a href="/event.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Event (All Photos)</a></li>-->
        ...
        <!-- <li class="topnav-list md-dropdown">
            <a class="dropdown-toggle" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Events</a>
            

            <ul class="my-sub-menu dropdown-menu md-dropdown-menu" id="navbarDropdowndropme">
                <li><a href="#"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Recruitment</a></li>
                <li><a href="/social-schemes.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Social scheme</a></li>

                <li><a href="/student-corner.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Student corner</a></li>
                <li><a href="#"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Gallery</a></li>
                <li><a href="/downloads.php"><i class="fa fa-angle-double-right text-secondary"></i>&nbsp;Download</a></li> 
            </ul>
